...
var sporktrum = {util:{}};
sporktrum.util.to_non_typed_array = function(a) {
  return Array.apply(cljs.core.PersistentVector.EMPTY, a);
};
sporktrum.util.freq_for_bin = function(a, b, c) {
  return b / c * a;
};
sporktrum.util.log_2 = Math.log.call(null, 2);
sporktrum.util.A4 = 440;
sporktrum.util.steps_from_A4 = function(a) {
  return 12 * Math.log.call(null, a / sporktrum.util.A4) / sporktrum.util.log_2;
};
sporktrum.util.freq_for_step = function(a) {
  return sporktrum.util.A4 * Math.pow.call(null, 2, a / 12);
};
sporktrum.core = {};
...
sporktrum.core.scale = new cljs.core.PersistentVector(null, 12, 5, cljs.core.PersistentVector.EMPTY_NODE, ["A", "B" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(sporktrum.core.flat), "B", "C", "C" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(sporktrum.core.sharp), "D", "E" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(sporktrum.core.flat), "E", "F", "F" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(sporktrum.core.sharp), "G", "A" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(sporktrum.core.flat)], 
null);
sporktrum.core.constraints = function() {
  return{video:!1, audio:!0};
}();
cljs.core.not.call(null, navigator.getUserMedia) && window.alert("getUserMedia not supported");
sporktrum.core.refs = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY);
sporktrum.core.draw_spectrum = function(a) {
  ...
  var b = sporktrum.util.freq_for_step.call(null, sporktrum.core.lower_bound_note), c = sporktrum.util.freq_for_step.call(null, sporktrum.core.upper_bound_note), d = (new cljs.core.Keyword(null, "freqs", "freqs", 1215470702)).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null, sporktrum.core.refs)), e = cljs.core.apply.call(null, cljs.core.array, d), f = d.indexOf(cljs.core.apply.call(null, cljs.core.min_key, function(a, b, c, d) {
    return function(b) {
      return Math.abs.call(null, a - b);
    };
  }(b, c, d, e), d)), g = d.indexOf(cljs.core.apply.call(null, cljs.core.min_key, function(a, b, c, d, e) {
    return function(a) {
      return Math.abs.call(null, b - a);
    };
  }(b, c, d, e, f), d));
  a = cljs.core.drop.call(null, f, cljs.core.take.call(null, g + 1, a));
  cljs.core.doall.call(null, cljs.core.map_indexed.call(null, function(a, b, c, d, e, f, g) {
    return function(a, b) {
      var c = (sporktrum.util.steps_from_A4.call(null, (new cljs.core.Keyword(null, "freq", "freq", -1855845278)).cljs$core$IFn$_invoke$arity$1(b)) - sporktrum.core.lower_bound_note) / sporktrum.core.steps * sporktrum.core.width, d = sporktrum.core.spectrum_baseline - (new cljs.core.Keyword(null, "mag", "mag", 48619174)).cljs$core$IFn$_invoke$arity$1(b) / 255 * sporktrum.core.spectrum_baseline;
      return sporktrum.core.ctx.lineTo(c, d);
    };
  }(b, c, d, e, f, g, a), a));
...
sporktrum.core.print_scale = function() {
  ...
  var a = cljs.core.range.call(null, sporktrum.core.lower_bound_note, sporktrum.core.upper_bound_note), b = function(a) {
    return function(a) {
      return 4 + Math.floor.call(null, a / 12);
    };
  }(a), c = cljs.core.map.call(null, function(a, b) {
    return function(a) {
      return 0 <= a ? "" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.call(null, cljs.core.cycle.call(null, sporktrum.core.scale), a)) + cljs.core.str.cljs$core$IFn$_invoke$arity$1(b.call(null, a)) : "" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.call(null, cljs.core.cycle.call(null, cljs.core.reverse.call(null, sporktrum.core.scale)), Math.abs.call(null, a))) + cljs.core.str.cljs$core$IFn$_invoke$arity$1(b.call(null, a));
    };
  }(a, b), a);
  return cljs.core.doall.call(null, cljs.core.map_indexed.call(null, function(a, b, c) {
    return function(a, b) {
      return sporktrum.core.ctx.fillText(b, a / sporktrum.core.steps * sporktrum.core.width, sporktrum.core.height - 6);
    };
  }(a, b, c), c));
};
sporktrum.core.draw_line_scale = function() {
  sporktrum.core.ctx.strokeStyle = "#8A8A8A";
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    a = a / 48 * sporktrum.core.width;
    sporktrum.core.ctx.beginPath();
    sporktrum.core.ctx.moveTo(a, 0);
    sporktrum.core.ctx.lineTo(a, sporktrum.core.spectrum_baseline);
...
sporktrum.core.clear = function() {
  sporktrum.core.ctx.fillStyle = "black";
  return sporktrum.core.ctx.fillRect(0, 0, sporktrum.core.width, sporktrum.core.height);
};
sporktrum.core.draw = function draw() {
  requestAnimationFrame(draw);
  var b = (new cljs.core.Keyword(null, "analyser", "analyser", -110219096)).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null, sporktrum.core.refs)), c = (new cljs.core.Keyword(null, "freq-data", "freq-data", -977208748)).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null, sporktrum.core.refs));
  b.getByteFrequencyData(c);
  var d = sporktrum.util.to_non_typed_array.call(null, c), b = cljs.core.map_indexed.call(null, function(b, c, d) {
    return function(c, d) {
      return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "freq", "freq", -1855845278), d, new cljs.core.Keyword(null, "mag", "mag", 48619174), cljs.core.nth.call(null, b, c)], null);
    };
  }(d, b, c), (new cljs.core.Keyword(null, "freqs", "freqs", 1215470702)).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null, sporktrum.core.refs)));
...
sporktrum.core.configure = function(a) {
  ...
  var c = b.createAnalyser();
  c.fftSize = 2048;
  c.minDecibels = -85;
  c.maxDecibels = -25;
  c.smoothingTimeConstant = .9;
  a.connect(c);
  cljs.core.swap_BANG_.call(null, sporktrum.core.refs, cljs.core.assoc, new cljs.core.Keyword(null, "source", "source", -433931539), a);
  cljs.core.swap_BANG_.call(null, sporktrum.core.refs, cljs.core.assoc, new cljs.core.Keyword(null, "analyser", "analyser", -110219096), c);
  cljs.core.swap_BANG_.call(null, sporktrum.core.refs, cljs.core.assoc, new cljs.core.Keyword(null, "sample-rate", "sample-rate", -603246554), b.sampleRate);
  cljs.core.swap_BANG_.call(null, sporktrum.core.refs, cljs.core.assoc, new cljs.core.Keyword(null, "fft-size", "fft-size", 773589460), c.fftSize);
  cljs.core.swap_BANG_.call(null, sporktrum.core.refs, cljs.core.assoc, new cljs.core.Keyword(null, "freq-bin-count", "freq-bin-count", 1095712575), c.frequencyBinCount);
  ...
  cljs.core.swap_BANG_.call(null, sporktrum.core.refs, cljs.core.assoc, new cljs.core.Keyword(null, "freqs", "freqs", 1215470702), cljs.core.apply.call(null, cljs.core.array, cljs.core.map.call(null, function(a, b, c) {
    return function(a) {
      return sporktrum.util.freq_for_bin.call(null, a, (new cljs.core.Keyword(null, "sample-rate", "sample-rate", -603246554)).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null, sporktrum.core.refs)), (new cljs.core.Keyword(null, "fft-size", "fft-size", 773589460)).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null, sporktrum.core.refs)));
    };
  }(b, a, c), cljs.core.range.call(null, 0, (new cljs.core.Keyword(null, "freq-bin-count", "freq-bin-count", 1095712575)).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null, sporktrum.core.refs))))));
  return requestAnimationFrame(sporktrum.core.draw);
};
sporktrum.core.err_callback = function(a) {
